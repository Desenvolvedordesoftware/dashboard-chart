...
import { getCandles } from './componet/DataService';
import useWebSocket from 'react-use-websocket';
import Candle from "./componet/Candle";
...
function App() {
  ...
  const {lastJsonMessage} = useWebSocket(`wss://stream.binance.com:9443/ws/${symbol.toLowerCase()}@line_${interval}`,{
